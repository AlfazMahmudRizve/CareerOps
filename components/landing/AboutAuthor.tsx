...
import { Github, Twitter, Linkedin, ExternalLink, Code } from 'lucide-react';
            ...
            >
                ...
                <div className="p-8 rounded-2xl border bg-card text-card-foreground shadow-sm">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <Link href="https://github.com/AlfazMahmudRizve" target="_blank" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors group">
                        ...
                        <Link href="https://whoisalfaz.me" target="_blank" className="flex items-center gap-2 text-muted-foreground hover:text-purple-400 transition-colors group">
